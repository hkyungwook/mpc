...
#define SHA1_BYTES				20		// SHA1_BYTES
#define SHA1_INTS				5		// SHA1_BYTES/4

#define NUM_EXECS_NAOR_PINKAS	80
#define NUM_NP_BYTES			10		// NUM_EXECS_NAOR_PINKAS/8	
#define NUM_NP_OT_BYTES			40		// NUM_NP_BYTES*4
#define NUM_NP_OT_INTS			10		// NUM_NP_OT_BYTES/4

#define OT_WINDOW_SIZE			(SHA1_BITS*128)			// must be multiples of 32
#define OT_WINDOW_SIZE_BYTES	(SHA1_BYTES*128)
		
#define BITS_TO_BYTES(a)		(((a)+7)/8)
#define BITS_TO_INTS(a)			(((a)+31)/32)
#define BYTES_TO_INTS(a)		(((a)+3)/4)
